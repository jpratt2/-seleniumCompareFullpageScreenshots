...
public class Screenshot2 {
    //this class uses Shutterbug https://github.com/assertthat/selenium-shutterbug
    //at this time it doesn't seem to work as well as the regular Screenshot class
     ...
     */
    public static void fullpage(WebDriver driver, String folderPath, String fileName){
        Shutterbug.shootPage(driver, Capture.FULL).withName(fileName).save(folderPath);
    }
    public static void fullpage(WebDriver driver, String folderPath){
        String url = driver.getCurrentUrl();
        String fileName = Utilities.convertUrlToFileName(url);
        fullpage(driver, folderPath, fileName);
    }
    public static void fullpage(WebDriver driver){
        String folderPath = "screenshots";
        fullpage(driver, folderPath);
    }


    //note: the following function has a bug
